...
function GalleryTwo() {
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: "url('/assets/img/bg/ppbng2.png')",
                    ...
                    <div className="col-lg-7">
                        <div className="title-area text-center text-lg-start mb-20 pe-xl-5 me-xl-5">
                            ...
                            <h2 className="sec-title">
                                Explore the most beautiful place in the Sri Lanka
                            </h2>
                        </div>
                        <p className="sec-text style2 text-title mb-50">
                        Discover unforgettable destinations that blend nature, culture, and adventure into perfect memories.
                        </p>
                    </div>
