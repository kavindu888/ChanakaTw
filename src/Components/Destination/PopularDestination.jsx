...
const sectionStyle = {
    position: "relative",
    overflow: "hidden",
    backgroundImage: "url('/assets/img/bg/ppdbg.png')",
            ...
            <div className="container">
                <div className="title-area mb-15 text-center">
                    ...
                    <p className="tour-text">
                        From the golden beaches of the south to the misty hills of the central highlands, discover Sri Lanka’s breathtaking beauty and unforgettable adventures waiting just for you.
                    </p>
                </div>
