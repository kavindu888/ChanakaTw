      ...
      >
        <SwiperSlide>
          <div className="hero-inner">
            <div className="th-hero-bg" style={{ backgroundImage: 'url(/assets/img/hero/hiroImg2.jpg)', backgroundRepeat: "no-repeat", backgroundSize: "cover" }} />
        ...
        <SwiperSlide>
          <div className="hero-inner">
            <video width={100} autoPlay loop muted>
              <source src="/assets/img/hero/hiro-video1.mp4" type="video/mp4" />
            </video>
            <div className="container">
              <div className="hero-style2">
                <h1 className="hero-title" data-ani="slideinup" data-ani-delay="0.4s">
        ...
        <SwiperSlide>
          <div className="hero-inner">
            <div className="th-hero-bg" style={{ backgroundImage: 'url(/assets/img/hero/hiroImg1.jpg)', backgroundRepeat: "no-repeat", backgroundSize: "cover" }} />
            <div className="container">
              <div className="hero-style2">
                <h1 className="hero-title" data-ani="slideinup" data-ani-delay="0.4s">
