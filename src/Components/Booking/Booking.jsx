...
function Booking() {
    ...
    Axios.get('http://192.168.8.187:8080/destination/1')
      .then((response) => {
      ...
      .catch((error) => {
        console.error('There was an error fetching the destination details!', error.Axios);
      });


      Axios.get('http://192.168.8.187:8080/type/1')
      .then((response) => {
        console.log(response.data.id);
        console.log(response.data.name);
        console.log(" ");
      ...
      .catch((error) => {
        console.error('There was an error fetching the types details!', error.Axios);
      });

    
    Axios.get('http://192.168.8.187:8080/category/1')
      .then((response) => {
        console.log(response.data.id);
        console.log(response.data.name);
        console.log(" ");
      ...
      .catch((error) => {
        console.error('There was an error fetching the category details!', error.Axios);
      });


      Axios.get('http://192.168.8.187:8080/duration/1')
      .then((response) => {
        console.log(response.data.id);
        console.log(response.data.name);
        console.log(" ");
      ...
      .catch((error) => {
        console.error('There was an error fetching the duration details!', error.Axios);
      });
